...
#import "OlympusStepperTableCell.h"
...
@implementation OlympusStepperTableCell
...
- (void)_updateLabel {
    ...
    self.textLabel.text = self.control.value == 1 ? self.specifier.properties[kHBStepperTableCellSingularLabelKey] : [NSString stringWithFormat:self.specifier.name, (float)self.control.value];
    [self setNeedsLayout];
}
